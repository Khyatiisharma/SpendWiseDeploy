...
exports.InternalServerException = exports.TooManyRequestsException = exports.ForbiddenException = exports.UnauthorizedException = exports.BadRequestException = exports.NotFoundException = exports.HttpException = exports.AppError = void 0;
...
class ForbiddenException extends AppError {
    constructor(message = "Forbidden", errorCode) {
        super(message, http_config_1.HTTPSTATUS.FORBIDDEN, errorCode);
    }
}
exports.ForbiddenException = ForbiddenException;
class TooManyRequestsException extends AppError {
    constructor(message = "Too many requests", errorCode) {
        super(message, http_config_1.HTTPSTATUS.TOO_MANY_REQUESTS, errorCode);
    }
}
