          ...
          {selected && !editableSelected ? (
            ...
            <CommandPrimitive.Input
              ...
              onValueChange={(value) => {
                ...
                if (editableSelected && creatable) {
                  const editedOption = { value, label: value };
                  setSelected(value ? editedOption : undefined);
                  onChange?.(editedOption);
                }
                        ...
                        {dropdowns
                          ...
                          .map((option) => {
                            return (
                              ...
                              onSelect={() => {
                                setInputValue(editableSelected ? option.label : "");
